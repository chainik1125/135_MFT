...
ax.plot(lsos_sc, uc_sc, "o-", color="#27408b", lw=2, label="this work: SC boundary")
ax.plot(lsos_sl, uc_sl, "s-", color="#b22222", lw=2, label="this work: SL-DM")
ax.annotate("SC", (0.06, 1.35), fontsize=15, fontweight="bold")
ax.annotate("SL", (0.012, 1.80), fontsize=12, fontweight="bold")
ax.annotate("DM", (0.13, 2.45), fontsize=15, fontweight="bold")
